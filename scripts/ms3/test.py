...
def main():
    ...
    model = model.cuda()
    # model = medcam.inject(model, output_dir="/18018998051/ETAVS_mmcv/visualization/gradcam", save_maps=True)
    model.eval()
...
if __name__ == '__main__':
    ...
    parser.add_argument("--save_pred_mask", action='store_true',
                        default=True, help="save predited masks or not")
    parser.add_argument('--save_dir', type=str,
                        default='visualization/MS3', help='save path')
